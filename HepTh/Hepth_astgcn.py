...
total_processing_cycle=2*sum(GNN_cycle_list_per_group_top)+sum(off_chip_cycle_list_per_group_top)+12*sum(RNN_cycle_list_per_group_top)+2*sum(BatchNorm_cycle_list_per_group_top)
